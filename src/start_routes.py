...
from controllers import lunch_routes, emergency_routes, school_routes, classroom_routes, class_routes, course_routes
...
if __name__ == "__main__":
     course_routes.app.run(debug=True, host='0.0.0.0', port=5000)
